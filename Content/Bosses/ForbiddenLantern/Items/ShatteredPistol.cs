...
namespace Clamity.Content.Bosses.ForbiddenLantern.Items
{
    ...
    public class ShatteredPistolShard : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.ai[0] == 1) color = Color.Cyan;
            ...
            for (int i = 1; i < 4; i++)
            {
                Gore bubble = Gore.NewGorePerfect(Projectile.GetSource_FromAI(), Projectile.position, Projectile.velocity * Main.rand.NextFloat(.1f, .15f) * i, 411);
